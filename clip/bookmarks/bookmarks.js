  ...
  if (kind === "exam") {
    ...
    return `
      <article class="bmCard">
        ...
        <div class="bmActions">
          <a class="btn smallBtn primary" href="/read/read.html?exam=${encodeURIComponent(targetId)}">Open</a>
          <a class="btn smallBtn" href="/play/play.html?exam=${encodeURIComponent(targetId)}">Start</a>
  ...
  if (kind === "question") {
    ...
    return `
      <article class="bmCard">
        ...
        <div class="bmActions">
          ${examId ? `<a class="btn smallBtn primary" href="/read/read.html?exam=${encodeURIComponent(examId)}&focus=${encodeURIComponent(targetId)}">Open in Exam</a>` : ""}
