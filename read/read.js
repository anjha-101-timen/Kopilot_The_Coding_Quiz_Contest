...
function setExamHeader(exam) {
  ...
  btnManage.href = new URL(`../update/update.html?exam=${encodeURIComponent(exam.id)}`, import.meta.url).href;

  const btnResults = el("btnResults");
  if (btnResults) btnResults.href = new URL(`../results/results.html?exam=${encodeURIComponent(exam.id)}`, import.meta.url).href;

  const btnStart = el("btnStart");
  if (btnStart) btnStart.href = new URL(`../play/play.html?exam=${encodeURIComponent(exam.id)}`, import.meta.url).href;
}
