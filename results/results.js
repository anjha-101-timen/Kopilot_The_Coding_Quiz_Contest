...
async function init() {
  try {
    ...
    el("btnBack").href = new URL(`../read/read.html?exam=${encodeURIComponent(exam)}`, import.meta.url).href;
    el("btnReattempt").href = new URL(`../play/play.html?exam=${encodeURIComponent(exam)}`, import.meta.url).href;
    el("btnSolutions").href = new URL(`../read/read.html?exam=${encodeURIComponent(exam)}`, import.meta.url).href;
