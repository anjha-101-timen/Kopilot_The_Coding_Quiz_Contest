...
function mount() {
  ...
  const topOpts = [
    { key: "nav.home", label: "Home", href: "/index.html", icon: "home" },
    { key: "nav.leetcode4000", label: "LeetCode 4000+", href: "/testseries/series.html?series=leetcode", icon: "leetcode" },
    { key: "nav.super4000leet", label: "super_4000_leet_problems", href: "/testseries/series.html?series=leetcode&tab=test&subtab=problem", icon: "leetcode" },
  ...
  presetCard.innerHTML = `
    ...
    <div class="small" style="margin-top:8px">Professional presets with carefully crafted color schemes for different coding environments.</div>
    <div class="row" style="margin-top:12px; flex-wrap:wrap">
      ...
      <button class="btn" id="cqcpPresetOcean" type="button">🌊 Ocean</button>
      <button class="btn" id="cqcpPresetForest" type="button">🌲 Forest</button>
      <button class="btn" id="cqcpPresetSunset" type="button">🌅 Sunset</button>
    </div>
  `;
  ...
  accentCard.innerHTML = `
    ...
    <div class="small" style="margin-top:8px">Choose from 15 carefully selected accent colors to personalize your coding experience.</div>
  ...
  const accents = [
    ...
    { key: "rose", bg: "linear-gradient(135deg,#F43F5E,#EC4899,#F97316)" },
    { key: "cyan", bg: "linear-gradient(135deg,#06B6D4,#22D3EE,#10B981)" },
    { key: "purple", bg: "linear-gradient(135deg,#A855F7,#22D3EE,#8B5CF6)" },
    { key: "pink", bg: "linear-gradient(135deg,#EC4899,#F97316,#F43F5E)" },
    { key: "teal", bg: "linear-gradient(135deg,#14B8A6,#22D3EE,#10B981)" },
    { key: "orange", bg: "linear-gradient(135deg,#F97316,#FCD34D,#F59E0B)" },
    { key: "red", bg: "linear-gradient(135deg,#EF4444,#F97316,#DC2626)" },
    { key: "indigo", bg: "linear-gradient(135deg,#6366F1,#22D3EE,#8B5CF6)" },
    { key: "mint", bg: "linear-gradient(135deg,#10B981,#22D3EE,#34D399)" },
    { key: "slate", bg: "linear-gradient(135deg,#475569,#22D3EE,#64748B)" }
  ];
  ...
  modal.querySelector("#cqcpPresetOcean").addEventListener("click", () => {
    const cur = getTheme();
    applyTheme({ ...cur, preset: "ocean" });
  });
  modal.querySelector("#cqcpPresetForest").addEventListener("click", () => {
    const cur = getTheme();
    applyTheme({ ...cur, preset: "forest" });
  });
  modal.querySelector("#cqcpPresetSunset").addEventListener("click", () => {
    const cur = getTheme();
    applyTheme({ ...cur, preset: "sunset" });
  });
